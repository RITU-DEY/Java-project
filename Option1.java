...
public class Option1 {
    ...
    Option1(String textField1) {
        ...
        label4 = new JLabel("Spaghetti ");
        label4.setBounds(600, 280, 1400, 40);
        label4.setFont(new Font("Serif", Font.BOLD, 22));

        label5 = new JLabel(new ImageIcon("image/Spaghetti.png"));
        label5.setBounds(100, 180, 450, 400);

        

        label6 = new JLabel("BDT 350");
        label6.setBounds(610, 380, 270, 40);
        label6.setFont(new Font("Serif", Font.BOLD, 35));

        label7 = new JLabel("8+ reviews");
        ...
        //frame.getContentPane().setBackground(new Color(206,212,218));
