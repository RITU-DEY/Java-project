...
public class Category1 {
    ...
    Category1(String textField1) {
        ...
        label3 = new JLabel("Select your pasta");
        ...
        b4 = new JButton();
        b4.setIcon(new ImageIcon("image/Spaghetti.png"));
        b4.setBounds(60, 160, 300, 220);
        b4.setCursor(new Cursor(Cursor.HAND_CURSOR));
        b4.setBackground(Color.white);
        

        l1 = new JButton("Spaghetti");
        ...
        b5 = new JButton();
        b5.setIcon(new ImageIcon("image/Rigatoni.jpeg"));
        b5.setBounds(380, 160, 300, 220);
        b5.setCursor(new Cursor(Cursor.HAND_CURSOR));
        b5.setBackground(Color.white);

        l2 = new JButton("Rigatoni");
