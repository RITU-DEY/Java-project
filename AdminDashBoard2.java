...
public class AdminDashBoard2 {
    ...
    JLabel lebel1, lebel2, lebel3, lebel4, lebel5, lebel6, lebel7, lebel8, lebel9, lebel10, lebel11,
            lebel12, lebel13, lebel14, lebel17,lebel18;
    ...
    AdminDashBoard2(String textField1) {
        ...
        lebel18 = new JLabel();
        lebel18.setIcon(new ImageIcon("image/registration.jpg"));
        Dimension size = lebel18.getPreferredSize();
        lebel18.setBounds(0, 0, size.width, size.height);
        ...
        lebel8 = new JLabel("User Name");
        lebel8.setBounds(800, 370, 200, 40);
        lebel8.setForeground(Color.black);
        lebel8.setFont(new Font("Segoe UI", Font.PLAIN, 18));
        ...
        lebel9 = new JLabel("Password");
        lebel9.setBounds(800, 440, 200, 40);
        ...
        lebel10 = new JLabel("Re-type Password");
        lebel10.setBounds(1100, 440, 200, 40);
        ...
        lebel11 = new JLabel("Security Questions");
        lebel11.setBounds(800, 515, 300, 40);
        ...
        lebel12 = new JLabel("Text your Answer");
        lebel12.setBounds(800, 560, 320, 30);
        ...
        lebel13 = new JLabel();
        lebel13.setText("Captcha");
        lebel13.setBounds(800, 600, 200, 30);
        ...
        lebel14 = new JLabel();
        lebel14.setText("   " + a + " + " + b + "  ");
        lebel14.setBounds(880, 602, 75, 30);
        lebel14.setForeground(Color.black);
        lebel14.setBackground(Color.decode("#FFD3D3"));
        lebel14.setFont(new Font("Segoe UI", Font.PLAIN, 18));
        lebel14.setBorder(null);
        lebel14.setOpaque(true);
