...
public class Category3 {
    ...
    Category3(String textField1) {
        ...
        label3 = new JLabel("Select your burger");
        ...
        b4 = new JButton();
        b4.setIcon(new ImageIcon("image/Chicken.jpeg"));
        b4.setBounds(60, 160, 300, 220);
        b4.setCursor(new Cursor(Cursor.HAND_CURSOR));
        b4.setBackground(Color.white);
        

        l1 = new JButton("Chicken Burger");
        ...
        b5 = new JButton();
        b5.setIcon(new ImageIcon("image/Beef.jpeg"));
        b5.setBounds(380, 160, 300, 220);
        b5.setCursor(new Cursor(Cursor.HAND_CURSOR));
        b5.setBackground(Color.white);
        
        l2 = new JButton("Beef Burger");
